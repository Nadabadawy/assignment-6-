...
reduced_dataa = transpose(reduced_data);
...
indices=getClosestCentroids(reduced_dataa, Intial_centroids);

 [centroids,error]=computeccentroids(reduced_dataa, indices, K);
